...
var _defaultApiURL = 'https://api.softlayer.com/rest/v3/';
var _apiUrlV3 = 'https://api.softlayer.com/rest/v3/';
var _apiUrlV3_1 = 'https://api.softlayer.com/rest/v3.1/';
/**
 * Constructor
 * @constructor
 * @param apiUser
 * @param apiKey
 * @param apiUrl Optional, defaults to v3
 */
var SoftLayer = function SoftLayer(apiUser, apiKey, apiUrl) {
    ...
    if (process.env.SOFTLAYER_API_URL) {
        this.credentials.apiUrl = process.env.SOFTLAYER_API_URL;
    }
    if (apiUrl) {
        this.credentials.apiUrl = apiUrl;
    }
    if (!this.credentials.apiUrl) this.credentials.apiUrl = _defaultApiURL;
};
...
SoftLayer.prototype.API_URL_V3 = _apiUrlV3;
SoftLayer.prototype.API_URL_V3_1 = _apiUrlV3_1;
 ...
 * @returns {SoftLayer}
 */
SoftLayer.prototype.auth = function (apiUser, apiKey, apiUrl) {
    if (!this.service) this.service = _getDefaults();
    this.credentials.apiUser = apiUser;
    this.credentials.apiKey = apiKey;
    if (apiUrl) this.credentials.apiUrl = apiUrl;
    if (!this.credentials.apiUrl) this.credentials.apiUrl = _apiUrlV3;
    return this;
};
...
SoftLayer.prototype.put = function (callback) {
    var _this = this;
    return new Promise(function (resolve, reject) {
        HttpRequests.put(_this.credentials, _this.service.pathElements, _this.service.offset, _this.service.limit, _this.service.headers, _this.service.parameters, function (error, result) {
            _this.reset();
            if (error) {
                return reject(error);
            }
...
SoftLayer.prototype.post = function (callback) {
    var _this = this;
    return new Promise(function (resolve, reject) {
        HttpRequests.post(_this.credentials, _this.service.pathElements, _this.service.offset, _this.service.limit, _this.service.headers, _this.service.parameters, function (error, result) {
            _this.reset();
            if (error) {
                return reject(error);
            }
...
SoftLayer.prototype.delete = function (callback) {
    var _this = this;
    return new Promise(function (resolve, reject) {
        HttpRequests.delete(_this.credentials, _this.service.pathElements, _this.service.offset, _this.service.limit, _this.service.headers, _this.service.parameters, function (error, result) {
            _this.reset();
            if (error) {
                return reject(error);
            }
