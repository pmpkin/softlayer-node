...
SoftLayer.prototype.put = function (callback) {
    var _this = this;
    return new Promise(function (resolve, reject) {
        HttpRequests.put(_this.credentials, _this.service.pathElements, _this.service.mask, _this.service.offset, _this.service.limit,_this.service.headers,_this.service.parameters, function (error, result) {
            _this.reset();
            if (error) {
                return reject(error);
            }
...
SoftLayer.prototype.post = function (callback) {
    var _this = this;
    return new Promise(function (resolve, reject) {
        HttpRequests.post(_this.credentials, _this.service.pathElements, _this.service.mask, _this.service.offset, _this.service.limit,_this.service.headers,_this.service.parameters, function (error, result) {
            _this.reset();
            if (error) {
                return reject(error);
            }
...
SoftLayer.prototype.delete = function (callback) {
    var _this = this;
    return new Promise(function (resolve, reject) {
        HttpRequests.delete(_this.credentials, _this.service.pathElements, _this.service.mask, _this.service.offset, _this.service.limit,_this.service.headers,_this.service.parameters, function (error, result) {
            _this.reset();
            if (error) {
                return reject(error);
            }
